...
val LaSanteTextSecondary = Color(0xFF757575)
val LaSanteCard = Color(0xFFE0E0E0)
val LaSanteButtonGray = Color(0xFFBDBDBD)

// Colores de estantes (Vitrina)
val ShelfBackground = Color(0xFFFFFFFF)
val ShelfShadowColor = Color(0x20000000)
...
val SpecialtyCardiologia = Color(0xFFF44336)
val SpecialtyNeurologia = Color(0xFF9C27B0)
val SpecialtyUrologia = Color(0xFF009688)
val SpecialtyGastroenterologia = Color(0xFFFF9800)
val SpecialtyPediatria = Color(0xFFE91E63)
